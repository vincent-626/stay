      ...
      <div className="absolute inset-0 min-w-full min-h-screen text-white bg-black">
        <div className="grid gap-4 p-8 bg-gray-900">
          <div>
            ...
            <button
              className="fixed flex gap-1 px-4 py-2 text-black transition-all duration-300 bg-white shadow top-8 right-12 rounded-2xl shadow-black hover:bg-gray-200"
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-8 mt-4">
      <div className="max-w-[1080px]">
        ...
        <a
          className="flex gap-1 my-3 font-semibold hover:underline"
          target="_blank"
        ...
        <div className="relative">
          ...
          <button
            className="absolute flex gap-1 px-4 py-2 transition-all duration-300 bg-white shadow-md shadow-gray-500 bottom-2 right-2 rounded-2xl hover:bg-gray-200"
            onClick={() => setShowAllPhotos(true)}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="px-8 py-8 bg-white border-t max-w-[1080px]">
        <div>
