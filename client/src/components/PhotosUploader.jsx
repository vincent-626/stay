  ...
  return (
    <>
      <div className="flex gap-2">
        ...
        />
        <button
          className="w-auto px-4 bg-gray-200 rounded-xl"
          onClick={addPhotoByLink}
        >
          Add photo
        </button>
      </div>
      <div className="grid grid-cols-2 gap-2 mt-4 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6">
        ...
        <label className="flex items-center justify-center h-48 gap-1 p-2 text-xl text-gray-600 bg-transparent border cursor-pointer rounded-2xl">
          <input
            type="file"
            className="hidden"
